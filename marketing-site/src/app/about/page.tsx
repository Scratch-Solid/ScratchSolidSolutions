...
export default function AboutPage() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-10 sm:py-16 px-3 sm:px-6 font-sans animate-fade-in pt-20 bg-white">
      <div className="max-w-5xl w-full space-y-8">
        <div className="glass-panel relative overflow-hidden border border-[#E9E0D3] shadow-2xl">
          ...
          <div className="relative z-10 p-6 sm:p-10">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-[#2E1F16] mb-4 sm:mb-6 text-center drop-shadow-lg">About Us</h1>
        ...
        {loading ? (
          ...
          <div className="text-base sm:text-lg text-zinc-800 mb-6 sm:mb-8 relative z-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#2E1F16] mb-4 text-center">About Scratch Solid Solutions</h2>
            ...
            <div className="my-6 sm:my-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="glass-card h-full">
                <h2 className="text-xl sm:text-2xl font-bold text-[#2E1F16] mb-2 text-center">Our Mission</h2>
              ...
              <div className="glass-card h-full">
                <h2 className="text-xl sm:text-2xl font-bold text-[#2E1F16] mb-2 text-center">Our Vision</h2>
                <p className="text-zinc-800 text-center mb-3 sm:mb-4 text-sm sm:text-base leading-relaxed">
            ...
            <div className="my-6 sm:my-8 glass-card">
              <h2 className="text-xl sm:text-2xl font-bold text-[#2E1F16] mb-4 text-center">Areas We Service</h2>
            ...
            <div className="my-6 sm:my-8 glass-card">
              <h2 className="text-xl sm:text-2xl font-bold text-[#2E1F16] mb-4 text-center">Core Values</h2>
            ...
            <div className="my-6 sm:my-8">
              <h2 className="text-xl sm:text-2xl font-bold text-[#2E1F16] mb-4 text-center">Our Leadership Team</h2>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {leader.image_url ? (
                            <img
                              ...
                              alt={leader.name}
                              className="w-24 h-24 sm:w-28 sm:h-28 rounded-full mx-auto mb-2 sm:mb-3 object-cover border-2 border-[#E9E0D3] shadow"
                            />
                          ) : (
                            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full mx-auto mb-2 sm:mb-3 bg-[#F7F2EA] flex items-center justify-center text-3xl text-[#2E1F16] font-bold">
                              {leader.name.charAt(0)}
                            </div>
                          )}
                          <h3 className="font-bold text-[#2E1F16] text-sm sm:text-base">{leader.name}</h3>
                        ...
                        <div
                          ...
                          className="bg-gradient-to-br from-[#2E1F16] to-[#8a6a45] rounded-xl p-4 sm:p-5 text-center flex flex-col items-center justify-center text-white"
                        >
                          <h3 className="font-bold text-sm sm:text-base mb-1">{leader.name}</h3>
                          <p className="text-[#E9DCC8] text-xs mb-2 sm:mb-3">{leader.title}</p>
                          <p className="text-white text-xs leading-relaxed px-1">
                            {leader.description || 'No bio available.'}
                          </p>
                          <p className="text-[#D3C2A5] text-[10px] mt-2 sm:mt-3">Tap to flip back</p>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            {statistics && (
              <div className="my-6 sm:my-8">
                <h2 className="text-xl sm:text-2xl font-bold text-[#2E1F16] mb-4 text-center">By the Numbers</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="glass-card text-center">
                    <p className="text-3xl font-extrabold text-[#2E1F16]">{statistics.clients_serviced}</p>
                    <p className="text-sm mt-1 text-gray-600">Clients Serviced</p>
                  </div>
                  <div className="glass-card text-center">
                    <p className="text-3xl font-extrabold text-[#2E1F16]">{statistics.jobs_completed}</p>
                    <p className="text-sm mt-1 text-gray-600">Jobs Completed</p>
                  </div>
                  <div className="glass-card text-center">
                    <p className="text-3xl font-extrabold text-[#2E1F16]">{statistics.average_rating > 0 ? `${statistics.average_rating}★` : 'N/A'}</p>
                    <p className="text-sm mt-1 text-gray-600">Average Rating</p>
                  </div>
                  <div className="glass-card text-center">
                    <p className="text-3xl font-extrabold text-[#2E1F16]">{statistics.reviews_count ?? 0}</p>

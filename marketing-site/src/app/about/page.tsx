      ...
      <div className="max-w-2xl w-full bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-6 sm:p-10 relative">
        ...
        {loading ? (
          ...
          <div className="text-base sm:text-lg text-zinc-800 mb-6 sm:mb-8 relative z-10">
            <p className="text-base sm:text-lg text-zinc-800 mb-4 sm:mb-6 text-center">{about.intro}</p>
            <div className="my-6 sm:my-8">
              <h2 className="text-xl sm:text-2xl font-bold text-blue-700 mb-2 text-center">Our Mission</h2>
              <p className="text-zinc-800 text-center mb-3 sm:mb-4 text-sm sm:text-base">{about.mission}</p>
              <h2 className="text-xl sm:text-2xl font-bold text-blue-700 mb-2 text-center">Our Vision</h2>
              <p className="text-zinc-800 text-center mb-3 sm:mb-4 text-sm sm:text-base">{about.vision}</p>
            ...
            <p className="text-base sm:text-lg text-zinc-800 mb-4 sm:mb-6 text-center">{about.outro}</p>
            <p className="text-lg sm:text-xl font-bold text-green-700 text-center mb-3 sm:mb-4">{about.slogan}</p>
          </div>
        ) : (

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-16 px-4 font-sans">
      <div className="max-w-2xl mx-auto bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-10 relative">
        ...
        <h1 className="text-4xl font-extrabold text-blue-700 mb-6 text-center drop-shadow-lg">Privacy Policy</h1>
        {content ? (
        ...
        <div className="flex justify-center gap-4 mt-8 relative z-10">
          <Link href="/terms" className="rounded-full bg-zinc-200 px-8 py-3 text-lg font-semibold text-blue-700 shadow hover:bg-zinc-300 transition-colors">Terms of Service</Link>

-- Portal Database Loyalty & Referrals Tables (Portal-specific)
-- Migration for scratchsolid-portal-db (production)

-- Loyalty points table (portal-specific for staff loyalty program)
...
-- Referrals table (portal-specific for staff referrals)

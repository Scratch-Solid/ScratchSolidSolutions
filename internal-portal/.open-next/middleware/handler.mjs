...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      class tK {
        ...
        get readable() {
          return null === this.response ? new ReadableStream({ start(e10) {
            e10.close();
          } }) : "string" == typeof this.response ? tq(this.response) : e7.Buffer.isBuffer(this.response) ? t$(this.response) : Array.isArray(this.response) ? function(...e10) {
        ...
        coerce() {
          return null === this.response ? [] : "string" == typeof this.response ? [tq(this.response)] : Array.isArray(this.response) ? this.response : e7.Buffer.isBuffer(this.response) ? [t$(this.response)] : [this.response];
        }
        pipeThrough(e10) {
      ...
      let re = ["/api/health", "/api/status", "/api/auth/login", "/api/auth/register", "/api/content/"];
      e.s(["config", 0, { matcher: ["/api/:path*"] }, "middleware", 0, function(e10) {
        let { pathname: t10 } = e10.nextUrl;
        if (re.some((e11) => t10.startsWith(e11)) || !t10.startsWith("/api/")) return es.next();
        if (!(e10.headers.get("Authorization")?.replace("Bearer ", "") || e10.cookies.get("authToken")?.value)) return es.json({ error: "Unauthorized" }, { status: 401 });
        let r2 = e10.headers.get("X-Request-ID") || e10.headers.get("X-Trace-ID") || crypto.randomUUID(), n2 = es.next();
        return n2.headers.set("X-Request-ID", r2), n2.headers.set("X-Trace-ID", r2), n2;
      }], 96592);
      ...
      async function ra(e10, t10) {
        let r2 = await ri({ request: { url: e10.url, method: e10.method, headers: w(e10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: true, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: rr }, body: "GET" !== e10.method && "HEAD" !== e10.method ? e10.body ?? void 0 : void 0, waitUntil: t10.waitUntil, requestMeta: t10.requestMeta, signal: t10.signal || new AbortController().signal } });
...
var NextConfig = { "env": {}, "webpack": null, "typescript": { "ignoreBuildErrors": true }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image/", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [], "qualities": [75], "unoptimized": true, "customCacheHandler": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": true, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": { "serverFunctions": true, "browserToTerminal": "warn" }, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/workspaces/ScratchSolidSolutions/internal-portal", "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "appNewScrollHandler": false, "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "cachedNavigations": false, "partialFallbacks": false, "dynamicOnHover": false, "varyParams": false, "prefetchInlining": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 1, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "strictRouteTypes": false, "viewTransition": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": true, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "gestureTransition": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": "warn", "lockDistDir": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": true, "turbopackPluginRuntimeStrategy": "childProcesses", "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "/workspaces/ScratchSolidSolutions/internal-portal" }, "distDirRoot": ".next" };
var BuildId = "QnPpEATMBbiS2qpIZeIF_";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:file((?!\\.well-known(?:/.*)?)(?:[^/]+/)*[^/]+\\.\\w+)/", "destination": "/:file", "internal": true, "priority": true, "missing": [{ "type": "header", "key": "x-nextjs-data" }], "statusCode": 308, "regex": "^(?:/((?!\\.well-known(?:/.*)?)(?:[^/]+/)*[^/]+\\.\\w+))/$" }, { "source": "/:notfile((?!\\.well-known(?:/.*)?)(?:[^/]+/)*[^/\\.]+)", "destination": "/:notfile/", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?!\\.well-known(?:/.*)?)(?:[^/]+/)*[^/\\.]+))$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/accounting", "regex": "^/accounting(?:/)?$", "routeKeys": {}, "namedRegex": "^/accounting(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/content", "regex": "^/admin/content(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content(?:/)?$" }, { "page": "/admin/content-upload", "regex": "^/admin/content\\-upload(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content\\-upload(?:/)?$" }, { "page": "/admin-contracts-payroll", "regex": "^/admin\\-contracts\\-payroll(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin\\-contracts\\-payroll(?:/)?$" }, { "page": "/admin-dashboard", "regex": "^/admin\\-dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin\\-dashboard(?:/)?$" }, { "page": "/api/admin/audit", "regex": "^/api/admin/audit(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/audit(?:/)?$" }, { "page": "/api/admin/bookings", "regex": "^/api/admin/bookings(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/bookings(?:/)?$" }, { "page": "/api/admin/bookings/auto-assign", "regex": "^/api/admin/bookings/auto\\-assign(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/bookings/auto\\-assign(?:/)?$" }, { "page": "/api/admin/businesses", "regex": "^/api/admin/businesses(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/businesses(?:/)?$" }, { "page": "/api/admin/cleaners", "regex": "^/api/admin/cleaners(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/cleaners(?:/)?$" }, { "page": "/api/admin/cleanup", "regex": "^/api/admin/cleanup(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/cleanup(?:/)?$" }, { "page": "/api/admin/permissions", "regex": "^/api/admin/permissions(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/permissions(?:/)?$" }, { "page": "/api/admin/reminders", "regex": "^/api/admin/reminders(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/reminders(?:/)?$" }, { "page": "/api/admin/roles", "regex": "^/api/admin/roles(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/roles(?:/)?$" }, { "page": "/api/admin/users", "regex": "^/api/admin/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/users(?:/)?$" }, { "page": "/api/auth/login", "regex": "^/api/auth/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/login(?:/)?$" }, { "page": "/api/auth/register", "regex": "^/api/auth/register(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/auth/register(?:/)?$" }, { "page": "/api/bookings", "regex": "^/api/bookings(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/bookings(?:/)?$" }, { "page": "/api/chatbot", "regex": "^/api/chatbot(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/chatbot(?:/)?$" }, { "page": "/api/cleaner-details", "regex": "^/api/cleaner\\-details(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cleaner\\-details(?:/)?$" }, { "page": "/api/cleaner-earnings", "regex": "^/api/cleaner\\-earnings(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cleaner\\-earnings(?:/)?$" }, { "page": "/api/cleaner-profile", "regex": "^/api/cleaner\\-profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cleaner\\-profile(?:/)?$" }, { "page": "/api/cleaner-status", "regex": "^/api/cleaner\\-status(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/cleaner\\-status(?:/)?$" }, { "page": "/api/contracts", "regex": "^/api/contracts(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/contracts(?:/)?$" }, { "page": "/api/employees", "regex": "^/api/employees(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/employees(?:/)?$" }, { "page": "/api/health", "regex": "^/api/health(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/health(?:/)?$" }, { "page": "/api/notifications", "regex": "^/api/notifications(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/notifications(?:/)?$" }, { "page": "/api/payroll", "regex": "^/api/payroll(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/payroll(?:/)?$" }, { "page": "/api/pending-contracts", "regex": "^/api/pending\\-contracts(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/pending\\-contracts(?:/)?$" }, { "page": "/api/status", "regex": "^/api/status(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/status(?:/)?$" }, { "page": "/api/templates", "regex": "^/api/templates(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/templates(?:/)?$" }, { "page": "/api/zoho/invoice", "regex": "^/api/zoho/invoice(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/zoho/invoice(?:/)?$" }, { "page": "/api/zoho/refund", "regex": "^/api/zoho/refund(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/zoho/refund(?:/)?$" }, { "page": "/auth/consent-submitted", "regex": "^/auth/consent\\-submitted(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/consent\\-submitted(?:/)?$" }, { "page": "/auth/contract", "regex": "^/auth/contract(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/contract(?:/)?$" }, { "page": "/auth/employee-consent", "regex": "^/auth/employee\\-consent(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/employee\\-consent(?:/)?$" }, { "page": "/auth/login", "regex": "^/auth/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/login(?:/)?$" }, { "page": "/auth/signup", "regex": "^/auth/signup(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/signup(?:/)?$" }, { "page": "/cleaner-dashboard", "regex": "^/cleaner\\-dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/cleaner\\-dashboard(?:/)?$" }, { "page": "/digital-dashboard", "regex": "^/digital\\-dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/digital\\-dashboard(?:/)?$" }, { "page": "/notifications", "regex": "^/notifications(?:/)?$", "routeKeys": {}, "namedRegex": "^/notifications(?:/)?$" }, { "page": "/payroll", "regex": "^/payroll(?:/)?$", "routeKeys": {}, "namedRegex": "^/payroll(?:/)?$" }, { "page": "/transport-dashboard", "regex": "^/transport\\-dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/transport\\-dashboard(?:/)?$" }], "dynamic": [{ "page": "/api/admin/bookings/[id]/assign", "regex": "^/api/admin/bookings/([^/]+?)/assign(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/bookings/(?<nxtPid>[^/]+?)/assign(?:/)?$" }, { "page": "/api/admin/bookings/[id]/suggest-cleaner", "regex": "^/api/admin/bookings/([^/]+?)/suggest\\-cleaner(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/bookings/(?<nxtPid>[^/]+?)/suggest\\-cleaner(?:/)?$" }, { "page": "/api/admin/content/[page]", "regex": "^/api/admin/content/([^/]+?)(?:/)?$", "routeKeys": { "nxtPpage": "nxtPpage" }, "namedRegex": "^/api/admin/content/(?<nxtPpage>[^/]+?)(?:/)?$" }, { "page": "/api/admin/contracts/[id]/update", "regex": "^/api/admin/contracts/([^/]+?)/update(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/contracts/(?<nxtPid>[^/]+?)/update(?:/)?$" }, { "page": "/api/admin/payroll/[id]/amend", "regex": "^/api/admin/payroll/([^/]+?)/amend(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/payroll/(?<nxtPid>[^/]+?)/amend(?:/)?$" }, { "page": "/api/admin/roles/[id]/permissions", "regex": "^/api/admin/roles/([^/]+?)/permissions(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/roles/(?<nxtPid>[^/]+?)/permissions(?:/)?$" }, { "page": "/api/admin/users/[id]/delete", "regex": "^/api/admin/users/([^/]+?)/delete(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/users/(?<nxtPid>[^/]+?)/delete(?:/)?$" }, { "page": "/api/admin/users/[id]/restore", "regex": "^/api/admin/users/([^/]+?)/restore(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/users/(?<nxtPid>[^/]+?)/restore(?:/)?$" }, { "page": "/api/bookings/[id]", "regex": "^/api/bookings/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/bookings/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/accounting": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/accounting", "dataRoute": "/accounting.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin", "dataRoute": "/admin.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/content": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/content", "dataRoute": "/admin/content.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/content-upload": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/content-upload", "dataRoute": "/admin/content-upload.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin-contracts-payroll": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin-contracts-payroll", "dataRoute": "/admin-contracts-payroll.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin-dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin-dashboard", "dataRoute": "/admin-dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/consent-submitted": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/consent-submitted", "dataRoute": "/auth/consent-submitted.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/contract": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/contract", "dataRoute": "/auth/contract.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/employee-consent": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/employee-consent", "dataRoute": "/auth/employee-consent.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/login", "dataRoute": "/auth/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/auth/signup": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/auth/signup", "dataRoute": "/auth/signup.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/cleaner-dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/cleaner-dashboard", "dataRoute": "/cleaner-dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/digital-dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/digital-dashboard", "dataRoute": "/digital-dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/notifications": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/notifications", "dataRoute": "/notifications.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/payroll": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/payroll", "dataRoute": "/payroll.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/transport-dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/transport-dashboard", "dataRoute": "/transport-dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "8de52e4be88ced02a6cd88c700c67c6f", "previewModeSigningKey": "0145942796a10597952097b85f1d17dcffeb7e034ac04cc6a9019b772aa0d474", "previewModeEncryptionKey": "884b4abb404ceacff6d79f1ae1c9723fd2b6aeb860a5b90110b1b5ae17a319d8" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0kvehva.js", "server/edge/chunks/[root-of-the-server]__08ca2jv._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0lcpsxv.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0lcpsxv.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/api(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "originalSource": "/api/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "QnPpEATMBbiS2qpIZeIF_", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "EziW5OHJqIQU7V/hVo2keNHNyS/tAO/1+C3TX5IYNSI=", "__NEXT_PREVIEW_MODE_ID": "8de52e4be88ced02a6cd88c700c67c6f", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "884b4abb404ceacff6d79f1ae1c9723fd2b6aeb860a5b90110b1b5ae17a319d8", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "0145942796a10597952097b85f1d17dcffeb7e034ac04cc6a9019b772aa0d474" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/accounting/page": "/accounting", "/admin-contracts-payroll/page": "/admin-contracts-payroll", "/admin-dashboard/page": "/admin-dashboard", "/admin/content-upload/page": "/admin/content-upload", "/admin/content/page": "/admin/content", "/admin/page": "/admin", "/api/admin/audit/route": "/api/admin/audit", "/api/admin/bookings/[id]/assign/route": "/api/admin/bookings/[id]/assign", "/api/admin/bookings/[id]/suggest-cleaner/route": "/api/admin/bookings/[id]/suggest-cleaner", "/api/admin/bookings/auto-assign/route": "/api/admin/bookings/auto-assign", "/api/admin/bookings/route": "/api/admin/bookings", "/api/admin/businesses/route": "/api/admin/businesses", "/api/admin/cleaners/route": "/api/admin/cleaners", "/api/admin/cleanup/route": "/api/admin/cleanup", "/api/admin/content/[page]/route": "/api/admin/content/[page]", "/api/admin/contracts/[id]/update/route": "/api/admin/contracts/[id]/update", "/api/admin/payroll/[id]/amend/route": "/api/admin/payroll/[id]/amend", "/api/admin/permissions/route": "/api/admin/permissions", "/api/admin/reminders/route": "/api/admin/reminders", "/api/admin/roles/[id]/permissions/route": "/api/admin/roles/[id]/permissions", "/api/admin/roles/route": "/api/admin/roles", "/api/admin/users/[id]/delete/route": "/api/admin/users/[id]/delete", "/api/admin/users/[id]/restore/route": "/api/admin/users/[id]/restore", "/api/admin/users/route": "/api/admin/users", "/api/auth/login/route": "/api/auth/login", "/api/auth/register/route": "/api/auth/register", "/api/bookings/[id]/route": "/api/bookings/[id]", "/api/bookings/route": "/api/bookings", "/api/chatbot/route": "/api/chatbot", "/api/cleaner-details/route": "/api/cleaner-details", "/api/cleaner-earnings/route": "/api/cleaner-earnings", "/api/cleaner-profile/route": "/api/cleaner-profile", "/api/cleaner-status/route": "/api/cleaner-status", "/api/contracts/route": "/api/contracts", "/api/employees/route": "/api/employees", "/api/health/route": "/api/health", "/api/notifications/route": "/api/notifications", "/api/payroll/route": "/api/payroll", "/api/pending-contracts/route": "/api/pending-contracts", "/api/status/route": "/api/status", "/api/templates/route": "/api/templates", "/api/zoho/invoice/route": "/api/zoho/invoice", "/api/zoho/refund/route": "/api/zoho/refund", "/auth/consent-submitted/page": "/auth/consent-submitted", "/auth/contract/page": "/auth/contract", "/auth/employee-consent/page": "/auth/employee-consent", "/auth/login/page": "/auth/login", "/auth/signup/page": "/auth/signup", "/cleaner-dashboard/page": "/cleaner-dashboard", "/digital-dashboard/page": "/digital-dashboard", "/notifications/page": "/notifications", "/page": "/", "/payroll/page": "/payroll", "/transport-dashboard/page": "/transport-dashboard" };

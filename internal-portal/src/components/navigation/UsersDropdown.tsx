...
export default function UsersDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-stone-200 z-50">
          <div className="p-3 border-b border-stone-100">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm border border-stone-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B08A5E]"
              />
            </div>
          </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs px-2 py-1 rounded-full ${
                      user.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-stone-100 text-stone-600'
                    }`}>
                      {user.status}
                    </span>
                  </div>
          ...
          <div className="p-3 border-t border-stone-100">
            <button
              ...
              className="w-full py-2 text-sm text-[#2E1F16] hover:text-[#241811] flex items-center justify-center gap-2"
            >

...
export default function ErpConsolePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">ERP Console</h1>
        <p className="text-sm text-slate-500 mt-1">Enterprise resource planning integration.</p>
      </div>
      ...
      {ERP_ENABLED ? (
        <div className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-slate-900">ERPNext</h2>
            </div>
        ...
        <div className="flex min-h-[60vh] items-center justify-center">
          <Card className="w-full max-w-lg text-center">
            <CardHeader>
              <div className="mx-auto mb-2 flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-100">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-left">
                <p className="text-xs font-medium text-slate-700">To enable:</p>
                <p className="mt-1 text-xs text-slate-500">
                  Set <code className="rounded bg-white px-1 py-0.5 font-mono text-slate-700 border border-slate-200">NEXT_PUBLIC_ERP_URL</code>{" "}
                  (e.g. <code className="rounded bg-white px-1 py-0.5 font-mono text-slate-700 border border-slate-200">https://erp.scratchsolidsolutions.org</code>)

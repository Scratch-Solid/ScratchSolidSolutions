...
export const NOTIFICATION_ERRORS = {
  ...
  CONVERSATION_WINDOW_CLOSED: (phone: string): ScratchSolidError => ({
    ...
    severity: 'info',
    audience: 'system',
    userMessage: 'WhatsApp conversation window is closed; using template message.',
    technicalDetail: `24h conversation window expired for ${phone}. Falling back to template message.`,
    nextSteps: 'If template fails, the system will send an email fallback automatically.',
    httpStatus: 200,
    retryable: false,
  }),
};

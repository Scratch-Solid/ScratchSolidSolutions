/**
 * @module redis-kv
 * @description Redis-backed Cloudflare KVNamespace-compatible facade
 * (`get`, `put`, `list`, `delete`). One Redis instance backs all logical
 * namespaces (RATE_LIMIT_KV, GPS_KV, PUSH_KV, STATUS_KV), isolated by prefix.
 */
